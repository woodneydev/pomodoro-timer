...
function Clock({session, isTimerRunning, focusDuration, breakDuration, minutesToDuration, secondsToDuration}) {
    ...
    return (
        <div>
            ...
            <div className="col">
                ...
                {session ? secondsToDuration(session.timeRemaining) : false} remaining
                </p>
            ...
            <div className="col">
                ...
                <div
                    ...
                    style={{ width: `${((1 - (session.timeRemaining / (focusDuration * 60 )))*100)}%` }} // TODO: Increase width % as elapsed time increases
                />
                </div>
            </div>
            </div>
